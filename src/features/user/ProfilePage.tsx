...
export default function ProfilePage() {
  ...
  if (!isLoggedIn || !user) {
    return (
      <div className="flex h-full flex-col items-center justify-center bg-surface-hover px-4">
        ...
        <p className="mb-6 text-ink-secondary">登录即可查看个人中心、发表点评、收藏商家</p>
        <button
  ...
  return (
    <div className="h-full overflow-y-auto bg-surface-hover pb-8">
      <div className="space-y-4 p-4">
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div className="rounded-gm-lg bg-white p-4 text-center shadow-gm-1">
            <p className="text-2xl font-normal text-ink-primary">{user.favoriteCount}</p>
            <p className="text-gm-base text-ink-secondary">收藏商家</p>
          </div>
        </div>
